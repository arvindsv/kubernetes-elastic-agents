...
public class KubernetesAgentInstancesIntegrationTest {
    ...
    private CreateAgentRequestContext createAgentRequestContext;
    ...
    public void setUp() {
        ...
        createAgentRequestContext = CreateAgentRequestMother.defaultCreateAgentRequest();
    ...
    public void shouldCreateKubernetesPodForCreateAgentRequest() {
        KubernetesInstance kubernetesInstance = kubernetesAgentInstances.create(createAgentRequestContext, settings, mockedPluginRequest);
    ...
    public void shouldCreateKubernetesPodWithContainerSpecification() {
        ...
        KubernetesInstance instance = kubernetesAgentInstances.create(createAgentRequestContext, settings, mockedPluginRequest);
    ...
    public void shouldCreateKubernetesPodWithPrivilegedMod() {
        createAgentRequestContext.properties().put(PRIVILEGED.getKey(), "true");
        ArgumentCaptor<Pod> argumentCaptor = ArgumentCaptor.forClass(Pod.class);
        KubernetesInstance instance = kubernetesAgentInstances.create(createAgentRequestContext, settings, mockedPluginRequest);
        verify(pods).create(argumentCaptor.capture());
        Pod elasticAgentPod = argumentCaptor.getValue();
    ...
    public void shouldCreateKubernetesPodWithResourcesLimitSpecificationOnGoCDAgentContainer() {
        ArgumentCaptor<Pod> argumentCaptor = ArgumentCaptor.forClass(Pod.class);
        kubernetesAgentInstances.create(createAgentRequestContext, settings, mockedPluginRequest);
        verify(pods).create(argumentCaptor.capture());
        Pod elasticAgentPod = argumentCaptor.getValue();
    ...
    public void shouldCreateKubernetesPodWithGoCDElasticAgentContainerContainingEnvironmentVariables() {
        ...
        expectedEnvVars.add(new EnvVar("GO_EA_AUTO_REGISTER_KEY", createAgentRequestContext.autoRegisterKey(), null));
        expectedEnvVars.add(new EnvVar("GO_EA_AUTO_REGISTER_ENVIRONMENT", createAgentRequestContext.environment(), null));
    ...
    public void shouldCreateKubernetesPodWithPodAnnotations() {
        ...
        expectedAnnotations.putAll(createAgentRequestContext.properties());
        expectedAnnotations.put(Constants.JOB_IDENTIFIER_LABEL_KEY, new Gson().toJson(createAgentRequestContext.jobIdentifier()));
    ...
    public void shouldCreateKubernetesPodWithPodLabels() {
        ...
        labels.put(Constants.JOB_ID_LABEL_KEY, createAgentRequestContext.jobIdentifier().getJobId().toString());
        labels.put(Constants.KUBERNETES_POD_KIND_LABEL_KEY, Constants.KUBERNETES_POD_KIND_LABEL_VALUE);
        labels.put(Constants.ENVIRONMENT_LABEL_KEY, createAgentRequestContext.environment());
    ...
    public void usingPodYamlConfigurations_shouldCreateKubernetesPodForCreateAgentRequest() {
        createAgentRequestContext = CreateAgentRequestMother.createAgentRequestUsingPodYaml();
        KubernetesInstance kubernetesInstance = kubernetesAgentInstances.create(createAgentRequestContext, settings, mockedPluginRequest);
    ...
    public void usingRemoteFile_shouldCreateKubernetesPodForCreateAgentRequest() {
        createAgentRequestContext = CreateAgentRequestMother.createAgentRequestUsingRemoteFile();
        KubernetesInstance kubernetesInstance = kubernetesAgentInstances.create(createAgentRequestContext, settings, mockedPluginRequest);
